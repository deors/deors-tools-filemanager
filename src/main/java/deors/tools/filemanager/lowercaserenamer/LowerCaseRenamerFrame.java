...
/**
 * The LowerCaseRenamer frame.
 *
 * @author deors
 * @version 1.0
 */
public final class LowerCaseRenamerFrame
extends JFrame
implements ActionListener, WindowListener, PropertyChangeListener, ActivityListener {
     ...
     * Serialization ID.
     */
    private static final long serialVersionUID = 8184233966460812272L;
    ...
    /**
     * The LowerCaseRenamerObject instance that will hold the
     * values and take care of control behaviors in this frame.
     */
    private LowerCaseRenamerObject lowerCaseRenamer;
     ...
     * The process worker.
     */
    private LowerCaseRenamerWorker worker;

    /**
     * Default constructor.
     */
    public LowerCaseRenamerFrame() {
    ...
    private void initialize() {
        ...
        setTitle(Resources.LOWERCASERENAMER_TITLE);
        setSize(w, h);
        setResizable(false);
        ...
        if (FileManagerRunner.rootDir != null) {
            getLowerCaseRenamer().setRootDir(new SensibleString(FileManagerRunner.rootDir));
        }
    }
    ...
    private JMenuItem getAboutMenuItem() {
        ...
        if (aboutMenuItem == null) {
            ...
            aboutMenuItem.setText(Resources.LOWERCASERENAMER_ABOUT);
    ...
    private void aboutAction() {
        ...
        JOptionPane.showMessageDialog(
            this,
            Resources.LOWERCASERENAMER_ABOUT_TEXT,
            Resources.LOWERCASERENAMER_TITLE,
    ...
    private void runProcess() {
        ...
        if (runningProcess) {
            ...
            if (ret == JOptionPane.YES_OPTION) {
                ...
                worker = new LowerCaseRenamerWorker(getLowerCaseRenamer());
    ...
    /**
     * This method initializes the lowerCaseRenamer bean.
     *
     * @return the lowerCaseRenamer bean
     */
    private LowerCaseRenamerObject getLowerCaseRenamer() {

        if (lowerCaseRenamer == null) {
            lowerCaseRenamer = new LowerCaseRenamerObject();
            lowerCaseRenamer.addPropertyChangeListener(this);
        }
        return lowerCaseRenamer;
    }
    ...
    private SensibleTextField getRootDirField() {
        ...
        if (rootDirField == null) {
            ...
            rootDirField.setData(getLowerCaseRenamer().getRootDir());
        }
        return rootDirField;
    }
    ...
    private SensibleCheckBox getApplyToFilesCheck() {
        ...
        if (applyToFilesCheck == null) {
            ...
            applyToFilesCheck.setData(getLowerCaseRenamer().getApplyToFiles());
        }
    ...
    private SensibleCheckBox getApplyToDirectoriesCheck() {
        ...
        if (applyToDirectoriesCheck == null) {
            ...
            applyToDirectoriesCheck.setData(getLowerCaseRenamer().getApplyToDirectories());
        }
    ...
    private SensibleCheckBox getRecurseCheck() {
        ...
        if (recurseCheck == null) {
            ...
            recurseCheck.setData(getLowerCaseRenamer().getRecurse());
        }
        return recurseCheck;
    }
    ...
    private SensibleCheckBox getFilterCheck() {
        ...
        if (filterCheck == null) {
            ...
            filterCheck.setData(getLowerCaseRenamer().getFilter());
        }
        return filterCheck;
    }
    ...
    private SensibleTextField getFilterRegexField() {
        ...
        if (filterRegexField == null) {
            ...
            filterRegexField.setData(getLowerCaseRenamer().getFilterRegex());
        }
    ...
    public void propertyChange(PropertyChangeEvent event) {
        ...
        if (event.getSource() == getLowerCaseRenamer()) {
            getOkButton().setEnabled(getLowerCaseRenamer().isDataComplete());
