 ...
 * @version 1.0
 */
public final class FileNameSequencerRunner implements Runnable {
     ...
     * Default constructor.
     */
    public FileNameSequencerRunner() {
        super();
    }
    ...
    public void run() {
        ...
        FileNameSequencerFrame application = new FileNameSequencerFrame();
