...
/**
 * The DateShifter frame.
 *
 * @author deors
 * @version 1.0
 */
public final class DateShifterFrame
    extends JFrame
     ...
     * Serialization ID.
     */
    private static final long serialVersionUID = -8278340691377843411L;
    ...
    /**
     * The DateShifterObject instance that will hold the
     * values and take care of control behaviors in this frame.
     */
    private DateShifterObject dateShifter;
    ...
    /**
     * The time shift label control.
     */
    private JLabel shiftLabel;

    /**
     * The time shift field control.
     */
    private SensibleTextField shiftField;
     ...
     * The process worker.
     */
    private DateShifterWorker worker;

    /**
     * Default constructor.
     */
    public DateShifterFrame() {
    ...
    private void initialize() {
        ...
        setTitle(Resources.DATESHIFTER_TITLE);
        setSize(w, h);
        setResizable(false);
        ...
        if (FileManagerRunner.rootDir != null) {
            getDateShifter().setRootDir(new SensibleString(FileManagerRunner.rootDir));
        }
    }
    ...
    private JMenuItem getAboutMenuItem() {
        ...
        if (aboutMenuItem == null) {
            ...
            aboutMenuItem.setText(Resources.DATESHIFTER_ABOUT);
    ...
    private void aboutAction() {
        ...
        JOptionPane.showMessageDialog(
            this,
            Resources.DATESHIFTER_ABOUT_TEXT,
            Resources.DATESHIFTER_TITLE,
    ...
    private JPanel getMainContentPanel() {
        ...
        if (mainContentPanel == null) {
            ...
            mainContentPanel.add(getShiftLabel(), null);
            mainContentPanel.add(getShiftField(), null);
    ...
    private void runProcess() {
        ...
        if (runningProcess) {
            ...
            if (ret == JOptionPane.YES_OPTION) {
                ...
                worker = new DateShifterWorker(getDateShifter());
    ...
    /**
     * This method initializes the dateShifter bean.
     *
     * @return the dateShifter bean
     */
    private DateShifterObject getDateShifter() {

        if (dateShifter == null) {
            dateShifter = new DateShifterObject();
            dateShifter.addPropertyChangeListener(this);
        }
        return dateShifter;
    }
    ...
    private SensibleTextField getRootDirField() {
        ...
        if (rootDirField == null) {
            ...
            rootDirField.setData(getDateShifter().getRootDir());
        }
        return rootDirField;
    }

    /**
     * This method initializes the time shift label control.
     *
     * @return the time shift label
     */
    private JLabel getShiftLabel() {
        ...
        if (shiftLabel == null) {
            ...
            shiftLabel.setBounds(x, y, w, h);
            shiftLabel.setText(Resources.FIELD_SHIFT);
        }
        return shiftLabel;
    }

    /**
     * This method initializes the time shift field control.
     *
     * @return the time shift field
     */
    private SensibleTextField getShiftField() {
        ...
        if (shiftField == null) {
            shiftField = new SensibleTextField();
            shiftField.setBounds(x, y, w, h);
            shiftField.setData(getDateShifter().getShift());
        }
        return shiftField;
    }
    ...
    private SensibleCheckBox getApplyToFilesCheck() {
        ...
        if (applyToFilesCheck == null) {
            ...
            applyToFilesCheck.setData(getDateShifter().getApplyToFiles());
        }
    ...
    private SensibleCheckBox getApplyToDirectoriesCheck() {
        ...
        if (applyToDirectoriesCheck == null) {
            ...
            applyToDirectoriesCheck.setData(getDateShifter().getApplyToDirectories());
        }
    ...
    private SensibleCheckBox getRecurseCheck() {
        ...
        if (recurseCheck == null) {
            ...
            recurseCheck.setData(getDateShifter().getRecurse());
        }
        return recurseCheck;
    }
    ...
    private SensibleCheckBox getFilterCheck() {
        ...
        if (filterCheck == null) {
            ...
            filterCheck.setData(getDateShifter().getFilter());
        }
        return filterCheck;
    }
    ...
    private SensibleTextField getFilterRegexField() {
        ...
        if (filterRegexField == null) {
            ...
            filterRegexField.setData(getDateShifter().getFilterRegex());
        }
    ...
    public void propertyChange(PropertyChangeEvent event) {
        ...
        if (event.getSource() == getDateShifter()) {
            getOkButton().setEnabled(getDateShifter().isDataComplete());
