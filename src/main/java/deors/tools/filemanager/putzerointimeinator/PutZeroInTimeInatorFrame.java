...
/**
 * The PutZeroInTimeInator frame.
 *
 * @author deors
 * @version 1.0
 */
public final class PutZeroInTimeInatorFrame
extends JFrame
implements ActionListener, WindowListener, PropertyChangeListener, ActivityListener {
     ...
     * Serialization ID.
     */
    private static final long serialVersionUID = 5507765167969056125L;
    ...
    /**
     * The PutZeroInTimeInatorObject instance that will hold the
     * values and take care of control behaviors in this frame.
     */
    private PutZeroInTimeInatorObject putZeroInTimeInator;
     ...
     * The process worker.
     */
    private PutZeroInTimeInatorWorker worker;

    /**
     * Default constructor.
     */
    public PutZeroInTimeInatorFrame() {
    ...
    private void initialize() {
        ...
        setTitle(Resources.PUTZEROINTIMEINATOR_TITLE);
        setSize(w, h);
        setResizable(false);
        ...
        if (FileManagerRunner.rootDir != null) {
            getPutZeroInTimeInator().setRootDir(new SensibleString(FileManagerRunner.rootDir));
        }
    }
    ...
    private JMenuItem getAboutMenuItem() {
        ...
        if (aboutMenuItem == null) {
            ...
            aboutMenuItem.setText(Resources.PUTZEROINTIMEINATOR_ABOUT);
    ...
    private void aboutAction() {
        ...
        JOptionPane.showMessageDialog(
            this,
            Resources.PUTZEROINTIMEINATOR_ABOUT_TEXT,
            Resources.PUTZEROINTIMEINATOR_TITLE,
    ...
    private void runProcess() {
        ...
        if (runningProcess) {
            ...
            if (ret == JOptionPane.YES_OPTION) {
                ...
                worker = new PutZeroInTimeInatorWorker(getPutZeroInTimeInator());
    ...
    /**
     * This method initializes the putZeroInTimeInator bean.
     *
     * @return the putZeroInTimeInator bean
     */
    private PutZeroInTimeInatorObject getPutZeroInTimeInator() {

        if (putZeroInTimeInator == null) {
            putZeroInTimeInator = new PutZeroInTimeInatorObject();
            putZeroInTimeInator.addPropertyChangeListener(this);
        }
        return putZeroInTimeInator;
    }
    ...
    private SensibleTextField getRootDirField() {
        ...
        if (rootDirField == null) {
            ...
            rootDirField.setData(getPutZeroInTimeInator().getRootDir());
        }
        return rootDirField;
    }
    ...
    private SensibleCheckBox getApplyToFilesCheck() {
        ...
        if (applyToFilesCheck == null) {
            ...
            applyToFilesCheck.setData(getPutZeroInTimeInator().getApplyToFiles());
        }
    ...
    private SensibleCheckBox getApplyToDirectoriesCheck() {
        ...
        if (applyToDirectoriesCheck == null) {
            ...
            applyToDirectoriesCheck.setData(getPutZeroInTimeInator().getApplyToDirectories());
        }
    ...
    private SensibleCheckBox getRecurseCheck() {
        ...
        if (recurseCheck == null) {
            ...
            recurseCheck.setData(getPutZeroInTimeInator().getRecurse());
        }
        return recurseCheck;
    }
    ...
    private SensibleCheckBox getFilterCheck() {
        ...
        if (filterCheck == null) {
            ...
            filterCheck.setData(getPutZeroInTimeInator().getFilter());
        }
        return filterCheck;
    }
    ...
    private SensibleTextField getFilterRegexField() {
        ...
        if (filterRegexField == null) {
            ...
            filterRegexField.setData(getPutZeroInTimeInator().getFilterRegex());
        }
    ...
    public void propertyChange(PropertyChangeEvent event) {
        ...
        if (event.getSource() == getPutZeroInTimeInator()) {
            getOkButton().setEnabled(getPutZeroInTimeInator().isDataComplete());
