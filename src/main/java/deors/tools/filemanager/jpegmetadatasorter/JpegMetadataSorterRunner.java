 ...
 * @version 1.0
 */
public final class JpegMetadataSorterRunner implements Runnable {
     ...
     * Default constructor.
     */
    public JpegMetadataSorterRunner() {
        super();
    }
    ...
    public void run() {
        ...
        JpegMetadataSorterFrame application = new JpegMetadataSorterFrame();
