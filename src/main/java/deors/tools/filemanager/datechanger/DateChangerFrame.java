...
/**
 * The DateChanger frame.
 *
 * @author deors
 * @version 1.0
 */
public final class DateChangerFrame
extends JFrame
implements ActionListener, WindowListener, PropertyChangeListener, ActivityListener {
     ...
     * Serialization ID.
     */
    private static final long serialVersionUID = 7788134590501562782L;
    ...
    /**
     * The DateChangerObject instance that will hold the
     * values and take care of control behaviors in this frame.
     */
    private DateChangerObject dateChanger;
    ...
    /**
     * The new date and time label control.
     */
    private JLabel newDateLabel;

    /**
     * The new date and time field control.
     */
    private SensibleTextField newDateField;
     ...
     * The process worker.
     */
    private DateChangerWorker worker;

    /**
     * Default constructor.
     */
    public DateChangerFrame() {
    ...
    private void initialize() {
        ...
        setTitle(Resources.DATECHANGER_TITLE);
        setSize(w, h);
        setResizable(false);
        ...
        if (FileManagerRunner.rootDir != null) {
            getDateChanger().setRootDir(new SensibleString(FileManagerRunner.rootDir));
        }
    }
    ...
    private JMenuItem getAboutMenuItem() {
        ...
        if (aboutMenuItem == null) {
            ...
            aboutMenuItem.setText(Resources.DATECHANGER_ABOUT);
    ...
    private void aboutAction() {
        ...
        JOptionPane.showMessageDialog(
            this,
            Resources.DATECHANGER_ABOUT_TEXT,
            Resources.DATECHANGER_TITLE,
    ...
    private JPanel getMainContentPanel() {
        ...
        if (mainContentPanel == null) {
            ...
            mainContentPanel.add(getNewDateLabel(), null);
            mainContentPanel.add(getNewDateField(), null);
    ...
    private void runProcess() {
        ...
        if (runningProcess) {
            ...
            if (ret == JOptionPane.YES_OPTION) {
                ...
                worker = new DateChangerWorker(getDateChanger());
    ...
    private void enableControls(boolean flag) {
        ...
        getNewDateField().setEnabled(flag);
    ...
    /**
     * This method initializes the dateChanger bean.
     *
     * @return the dateChanger bean
     */
    private DateChangerObject getDateChanger() {

        if (dateChanger == null) {
            dateChanger = new DateChangerObject();
            dateChanger.addPropertyChangeListener(this);
        }
        return dateChanger;
    }
    ...
    private SensibleTextField getRootDirField() {
        ...
        if (rootDirField == null) {
            ...
            rootDirField.setData(getDateChanger().getRootDir());
        }
        return rootDirField;
    }

    /**
     * This method initializes the new date and time label control.
     *
     * @return the new date and time label
     */
    private JLabel getNewDateLabel() {
        ...
        if (newDateLabel == null) {
            newDateLabel = new JLabel();
            newDateLabel.setBounds(x, y, w, h);
            newDateLabel.setText(Resources.FIELD_NEWDATE);
        }
        return newDateLabel;
    }

    /**
     * This method initializes the new date and time field control.
     *
     * @return the new date and time field
     */
    private SensibleTextField getNewDateField() {
        ...
        if (newDateField == null) {
            newDateField = new SensibleTextField();
            newDateField.setBounds(x, y, w, h);
            newDateField.setData(getDateChanger().getNewDate());
        }
        return newDateField;
    }
    ...
    private SensibleCheckBox getApplyToFilesCheck() {
        ...
        if (applyToFilesCheck == null) {
            ...
            applyToFilesCheck.setData(getDateChanger().getApplyToFiles());
        }
    ...
    private SensibleCheckBox getApplyToDirectoriesCheck() {
        ...
        if (applyToDirectoriesCheck == null) {
            ...
            applyToDirectoriesCheck.setData(getDateChanger().getApplyToDirectories());
        }
    ...
    private SensibleCheckBox getRecurseCheck() {
        ...
        if (recurseCheck == null) {
            ...
            recurseCheck.setData(getDateChanger().getRecurse());
        }
        return recurseCheck;
    }
    ...
    private SensibleCheckBox getFilterCheck() {
        ...
        if (filterCheck == null) {
            ...
            filterCheck.setData(getDateChanger().getFilter());
        }
        return filterCheck;
    }
    ...
    private SensibleTextField getFilterRegexField() {
        ...
        if (filterRegexField == null) {
            ...
            filterRegexField.setData(getDateChanger().getFilterRegex());
        }
    ...
    public void propertyChange(PropertyChangeEvent event) {
        ...
        if (event.getSource() == getDateChanger()) {
            getOkButton().setEnabled(getDateChanger().isDataComplete());
