...
/**
 * The FileNameReSequencer object.
 *
 * @author deors
 * @version 1.0
 */
public class FileNameReSequencerObject extends deors.core.sensible.SensibleObject {

    /**
     * Serialization ID.
     */
    private static final long serialVersionUID = -1847263059182736451L;
     ...
     */
    @SuppressWarnings("PMD.SingularField")
    private final deors.core.sensible.SensibleBigDecimal start;
    ...
    /**
     * The start index order.
     */
    private static final int START_ORDER = 2;
    ...
    public FileNameReSequencerObject() {
        ...
        fields = new deors.core.sensible.SensibleDataType[] {
            prefix, offset, start, rootDir, recurse, applyToFiles, applyToDirectories, filter, filterRegex};
        fieldNames = new String[] {
            "prefix", "offset", "start", "rootDir", "recurse", "applyToFiles", "applyToDirectories", "filter", "filterRegex"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
     ...
     */
    public deors.core.sensible.SensibleBigDecimal getStart() {

        return (deors.core.sensible.SensibleBigDecimal) getField(START_ORDER);
    }
    ...
    /**
     * Changes the start index value.
     *
     * @param start the new value for the start index
     */
    public void setStart(deors.core.sensible.SensibleBigDecimal start) {

        setField(START_ORDER, start);
    }
