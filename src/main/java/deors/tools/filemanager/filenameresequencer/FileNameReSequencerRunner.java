 ...
 * @version 1.0
 */
public final class FileNameReSequencerRunner implements Runnable {
     ...
     * Default constructor.
     */
    public FileNameReSequencerRunner() {
        super();
    }
    ...
    public void run() {
        ...
        FileNameReSequencerFrame application = new FileNameReSequencerFrame();
