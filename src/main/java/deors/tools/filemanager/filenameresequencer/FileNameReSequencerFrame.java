...
/**
 * The FileNameReSequencer frame.
 *
 * @author deors
 * @version 1.0
 */
public final class FileNameReSequencerFrame
    extends JFrame
     ...
     * Serialization ID.
     */
    private static final long serialVersionUID = 3847261902837465129L;
    ...
    /**
     * The FileNameReSequencerObject instance that will hold the
     * values and take care of control behaviors in this frame.
     */
    private FileNameReSequencerObject fileNameReSequencer;
    ...
    /**
     * The start index label control.
     */
    private JLabel startLabel;

    /**
     * The start index field control.
     */
    private SensibleTextField startField;
     ...
     * The process worker.
     */
    private FileNameReSequencerWorker worker;

    /**
     * Default constructor.
     */
    public FileNameReSequencerFrame() {
    ...
    private void initialize() {
        ...
        setTitle(Resources.FILENAMERESEQUENCER_TITLE);
        setResizable(false);
        ...
        if (FileManagerRunner.rootDir != null) {
            getFileNameReSequencer().setRootDir(new SensibleString(FileManagerRunner.rootDir));
        }
    }
    ...
    private JMenuItem getAboutMenuItem() {
        ...
        if (aboutMenuItem == null) {
            ...
            aboutMenuItem.setText(Resources.FILENAMERESEQUENCER_ABOUT);
    ...
    private void aboutAction() {
        ...
        JOptionPane.showMessageDialog(
            this,
            Resources.FILENAMERESEQUENCER_ABOUT_TEXT,
            Resources.FILENAMERESEQUENCER_TITLE,
    ...
    private JPanel getMainContentPanel() {
        ...
        if (mainContentPanel == null) {
            ...
            mainContentPanel.add(getStartLabel(), null);
            mainContentPanel.add(getStartField(), null);
    ...
    private void runProcess() {
        ...
        if (runningProcess) {
            ...
            if (ret == JOptionPane.YES_OPTION) {
                ...
                worker = new FileNameReSequencerWorker(getFileNameReSequencer());
    ...
    /**
     * This method initializes the fileNameReSequencer bean.
     *
     * @return the fileNameReSequencer bean
     */
    private FileNameReSequencerObject getFileNameReSequencer() {

        if (fileNameReSequencer == null) {
            fileNameReSequencer = new FileNameReSequencerObject();
            fileNameReSequencer.addPropertyChangeListener(this);
        }
        return fileNameReSequencer;
    }
    ...
    private SensibleTextField getRootDirField() {
        ...
        if (rootDirField == null) {
            ...
            rootDirField.setData(getFileNameReSequencer().getRootDir());
        }
        return rootDirField;
    }
    ...
    private SensibleTextField getPrefixField() {
        ...
        if (prefixField == null) {
            ...
            prefixField.setData(getFileNameReSequencer().getPrefix());
        }
        return prefixField;
    }
    ...
    private SensibleTextField getOffsetField() {
        ...
        if (offsetField == null) {
            ...
            offsetField.setData(getFileNameReSequencer().getOffset());
        }
        return offsetField;
    }

    /**
     * This method initializes the start index label control.
     *
     * @return the start index label
     */
    private JLabel getStartLabel() {
        ...
        if (startLabel == null) {
            ...
            startLabel.setBounds(x, y, w, h);
            startLabel.setText(Resources.FIELD_START);
        }
        return startLabel;
    }

    /**
     * This method initializes the start index field control.
     *
     * @return the start index field
     */
    private SensibleTextField getStartField() {
        ...
        if (startField == null) {
            startField = new SensibleTextField();
            startField.setBounds(x, y, w, h);
            startField.setData(getFileNameReSequencer().getStart());
        }
        return startField;
    }
    ...
    private SensibleCheckBox getRecurseCheck() {
        ...
        if (recurseCheck == null) {
            ...
            recurseCheck.setData(getFileNameReSequencer().getRecurse());
        }
        return recurseCheck;
    }
    ...
    private SensibleCheckBox getFilterCheck() {
        ...
        if (filterCheck == null) {
            ...
            filterCheck.setData(getFileNameReSequencer().getFilter());
        }
        return filterCheck;
    }
    ...
    private SensibleTextField getFilterRegexField() {
        ...
        if (filterRegexField == null) {
            ...
            filterRegexField.setData(getFileNameReSequencer().getFilterRegex());
        }
    ...
    public void propertyChange(PropertyChangeEvent event) {
        ...
        if (event.getSource() == getFileNameReSequencer()) {
            getOkButton().setEnabled(getFileNameReSequencer().isDataComplete());
